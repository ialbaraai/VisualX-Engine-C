...
void shader_class_use(shader_t* object, int argc, void** argv)
{
    (void)argc;
    (void)argv;
...
void shader_class_setbool(shader_t* object, int argc, void** argv)
{
    if (object && argc == 2)
    {
...
void shader_class_setint(shader_t* object, int argc, void** argv)
{
    if (object && argc == 2)
    {
        const char* name  = argv[0];
...
void shader_class_setfloat(shader_t* object, int argc, void** argv)
{
    if (object && argc == 2)
    {
        const char* name = argv[0];
...
int shader_constructor(shader_t* instance, int argc, void** argv)
{
    if (instance)
    {
...
void shader_destructor(shader_t* instance)
{
    if (!instance) return;
